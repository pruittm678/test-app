    ...
    <section className="relative w-full">
      ...
      <div className="relative w-full h-[70vh] overflow-hidden">
        ...
        <div className="absolute bottom-12 left-8 md:left-16 max-w-2xl">
          ...
          <button
            onClick={() => onAdd(hero)}
            className="flex items-center gap-2 bg-indigo-500 hover:bg-indigo-400 text-white px-6 py-3 rounded-lg font-medium transition-colors"
          >
            <Plus size={20} />
            Add to Ranking
          </button>
      ...
      {/* Trending Row */}
      <div className="px-8 md:px-16 -mt-16 relative z-10">
            ...
            >
              <div className="relative aspect-[2/3]">
                ...
                <button
                  ...
                  className="absolute bottom-2 right-2 bg-indigo-500 hover:bg-indigo-400 text-white p-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"
