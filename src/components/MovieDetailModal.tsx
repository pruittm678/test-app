...
export default function MovieDetailModal({
  ...
  return (
    <div
      className={`fixed inset-0 z-50 flex items-center justify-center p-4 md:p-8 transition-colors duration-200 ${
        ...
        <div className="relative px-6 pb-6 -mt-20">
          <div className="flex gap-5">
            ...
            <div className="flex-1 pt-12">
              ...
              {tagline && (
                <p className="text-sm text-zinc-400 italic mt-1">{tagline}</p>
              )}
              <div className="flex flex-wrap items-center gap-3 mt-3 text-sm text-zinc-300">
          ...
          <button
            onClick={() => onAdd(movie)}
            className="mt-6 flex items-center gap-2 bg-indigo-500 hover:bg-indigo-400 text-white px-6 py-3 rounded-lg font-medium transition-colors w-full justify-center"
          >
            <Plus size={20} />
            Add to Ranking
          </button>
